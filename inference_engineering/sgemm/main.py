...
# image will be the default docker container for every function that runs on this app
app = modal.App("sgemm", image=image)

@app.function(gpu="H100", timeout=300)
def go(src: str):  # the function that runs on the H100, src is the kernel source code
